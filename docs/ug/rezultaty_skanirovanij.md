...
Дополнительная вкладка **Лог** предоставляет возможность просмотра лога сканирования. Она доступна только во время анализа результатов сканирования, когда у сканирования в **Списке сканирований** в поле **Состояние** отображается значение **Анализ**.
