...
* **Критичность** дефекта (Критический, Высокий, Средний, Низкий, Инфо и Неизвестно).
* **Инструмент** — название инструмента, обнаружившего дефект (Stingray, Appscreener, Oversecured).
* **Статус** дефекта (Не обработан, Подтвержден, Ложное срабатывание).
* **Состояние** дефекта (Новый, Повторный и Исправлен).
