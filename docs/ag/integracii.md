...
1.	Откройте страницу редактирования профиля компании, нажав на ее логотип в левом верхнем углу пользовательского интерфейса. 
2.	Выберите вкладку **Интеграции**.
3.	В меню справа выберите пункт **LDAP**.
...
6. Заполнив все поля, нажмите кнопку **Добавить**.
...
2. На открывшейся странице нажмите кнопку **+Добавить мапирование**.
