...
Нажмите на кнопку **Добавить проектную роль**. В появившемся окне выберите нужного пользователя (или группу пользователей) в области **Проектные роли** в поле **Пользователь или группа** и назначьте ему необходимую проектную роль, выбрав значение в раскрывающемся списке **Роль**. В завершении нажмите на кнопку **Добавить**. Более подробная информация о группах пользователей приведена в разделе «[Группы пользователей](./polzovateli.md#_10)».
