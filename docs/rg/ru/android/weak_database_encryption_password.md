...
Пароль, который используется для шифрования базы данных, не удовлетворяет критериям по длине, простоте или частоте использования. Основным параметром надежности хранения данных в зашифрованной базе данных на устройстве является пароль, который применяется для шифрования. Если выбранный пароль слишком простой или присутствует в базе самых распространенных паролей, велика вероятность подбора пароля и компрометации информации.
